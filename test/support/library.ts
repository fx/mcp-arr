...
/**
 * A library adapter harness backed by the real upstream client, so a test
 * exercises the same path joining, query encoding, and error normalization the
 * server uses — only the network is replaced.
 */
