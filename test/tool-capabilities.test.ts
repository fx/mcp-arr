...
describe("arr_capabilities", () => {
  ...
  it("advertises exactly the operations that already have adapter behavior", async () => {
    ...
    expect(reportFor(result, "sonarr").supportedOperations.map(operationKey)).toEqual([
      ...
      "arr_import_inspect/queue_item",
      "arr_import_inspect/library_context",
      "arr_import_inspect/candidate_reprocess",
      "arr_config_observe/indexers",
      "arr_config_observe/download_clients",
      "arr_config_observe/notifications",
      "arr_config_observe/import_lists",
      "arr_config_observe/metadata",
      "arr_config_observe/quality_profiles",
      "arr_config_observe/custom_formats",
      "arr_config_observe/release_profiles",
      "arr_config_observe/delay_profiles",
      "arr_config_observe/tags",
      "arr_config_observe/root_folders",
      "arr_config_observe/remote_path_mappings",
      "arr_config_observe/import_list_exclusions",
      "arr_job_get/-",
      ...
      "arr_release_grab/-",
      "arr_queue_resolve/ignore_tracking",
      "arr_queue_resolve/remove_from_client_and_delete_data",
      "arr_queue_resolve/blocklist_and_remove",
      "arr_queue_resolve/change_category_mark_imported",
      "arr_queue_resolve/route_to_manual_import",
      "arr_queue_resolve/force_pending_grab",
      "arr_queue_resolve/remove_pending",
      "arr_queue_resolve/blocklist_pending",
      "arr_activity_change/mark_history_failed",
      "arr_activity_change/remove_blocklist_record",
      "arr_import_execute/-",
    ...
    expect(reportFor(result, "prowlarr").supportedOperations.map(operationKey)).toEqual([
      ...
      "arr_config_observe/indexers",
      "arr_config_observe/download_clients",
      "arr_config_observe/applications",
      "arr_config_observe/notifications",
      "arr_config_observe/proxies",
      "arr_config_observe/app_profiles",
      "arr_config_observe/tags",
      "arr_job_get/-",
      "arr_release_grab/-",
      "arr_config_reconcile/reconcile_provider",
